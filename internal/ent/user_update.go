...
func (_u *UserUpdate) SetGithubToken(v string) *UserUpdate {
	_u.mutation.SetGithubToken(v)
	return _u
}

// SetNillableGithubToken sets the "github_token" field if the given value is not nil.
func (_u *UserUpdate) SetNillableGithubToken(v *string) *UserUpdate {
	if v != nil {
		_u.SetGithubToken(*v)
	}
	return _u
...
func (_u *UserUpdate) ClearGithubToken() *UserUpdate {
...
// SetGithubToken sets the "github_token" field.
func (_u *UserUpdateOne) SetGithubToken(v string) *UserUpdateOne {
	_u.mutation.SetGithubToken(v)
	return _u
}

// SetNillableGithubToken sets the "github_token" field if the given value is not nil.
func (_u *UserUpdateOne) SetNillableGithubToken(v *string) *UserUpdateOne {
	if v != nil {
		_u.SetGithubToken(*v)
	}
	return _u
...
// ClearGithubToken clears the value of the "github_token" field.
func (_u *UserUpdateOne) ClearGithubToken() *UserUpdateOne {
	_u.mutation.ClearGithubToken()
	return _u
}
