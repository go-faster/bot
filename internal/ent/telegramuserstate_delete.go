...
func (_d *TelegramUserStateDelete) Where(ps ...predicate.TelegramUserState) *TelegramUserStateDelete {
	_d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query and returns how many vertices were deleted.
func (_d *TelegramUserStateDelete) Exec(ctx context.Context) (int, error) {
	return withHooks(ctx, _d.sqlExec, _d.mutation, _d.hooks)
}

// ExecX is like Exec, but panics if an error occurs.
func (_d *TelegramUserStateDelete) ExecX(ctx context.Context) int {
	n, err := _d.Exec(ctx)
	if err != nil {
		panic(err)
	}
...
func (_d *TelegramUserStateDelete) sqlExec(ctx context.Context) (int, error) {
...
type TelegramUserStateDeleteOne struct {
	_d *TelegramUserStateDelete
}

// Where appends a list predicates to the TelegramUserStateDelete builder.
func (_d *TelegramUserStateDeleteOne) Where(ps ...predicate.TelegramUserState) *TelegramUserStateDeleteOne {
	_d._d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query.
func (_d *TelegramUserStateDeleteOne) Exec(ctx context.Context) error {
...
// ExecX is like Exec, but panics if an error occurs.
func (_d *TelegramUserStateDeleteOne) ExecX(ctx context.Context) {
